...
public class Year {
	...
	public static void input() {
		...
		System.out.println("====================================\n" + "This year you will turn " + (2017 - input)
				+ " years old" + "\n====================================\n");

		int year = input;
		String yearString;
		int minusCase = (input - (2017 - input));

		// facts about year of birth
		...
		case 1956:
			...
			break;
		case 1957:
			yearString = "Russia launches Sputnik I, first earth-orbiting satellite葉he Space Age begins (Oct. 4).";
			break;
		case 1958:
		...
		case 1959:
			...
			break;
		case 1960:
			yearString = "Top Nazi murderer of Jews, Adolf Eichmann, captured by Israelis in Argentina (May 23)容xecuted in Israel in 1962.";
			break;
		case 1961:
		...
		case 1968:
			...
			break;
		case 1969:
			yearString = "Apollo 11 astronauts湧eil A. Armstrong and Edwin E. Aldrin, Jr., 葉ake first walk on the Moon (July 20).";
			break;
		case 1970:
		...
		case 1988:
			...
			break;
		case 1989:
			yearString = "After 28 years, the Berlin Wall is open to West";
			break;
		case 1990:
			yearString = "South Africa frees Nelson Mandela, imprisoned 27ｽ years (Feb. 11).";
			break;
		case 1991:
		...
		//Facts about current age years before birth
			...
			case 2000:
				...
				break;
			default:
				yearString = "The year was " + (input - (2017 - input));
				break;
			}
			System.out.println("\n" + (2017 - input) + " years before you where born: " + yearString);
